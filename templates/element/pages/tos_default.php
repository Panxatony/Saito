<?php
/**
 * The shipped default terms of service, rendered by /pages/tos when a forum has
 * not set its own `Saito.tos`. The forum name is substituted from the settings;
 * the operator's legal identity is the one named in the imprint. An installation
 * that wants different terms sets `Saito.tos` and this is not reached.
 *
 * Numbered clauses are `<p>N. …</p>`, not an `<ol>`: it keeps every clause flush
 * with the § headings and the § 1 lead, where a list's own indent would step the
 * numbered sections in and out of line. Sub-points stay a `<ul>`.
 *
 * @var \App\View\AppView $this
 */
use Cake\Core\Configure;

$forum = h((string)Configure::read('Saito.Settings.forum_name'));
?>
