...
/**
 * Nova theme layout (SPA shell).
 *
 * Same structure as Bota's — the SPA and Saito's shared elements depend on these
 * ids — with Nova's own stylesheets. Fonts and smilies come from Bota, which
 * serves its webroot at /bota/, so nothing is duplicated here.
 */
