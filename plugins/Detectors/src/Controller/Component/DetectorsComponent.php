...
class DetectorsComponent extends Component
{
    ...
    public function isMobile(): bool
    {
        ...
        /*
         * Curtesy of http://detectmobilebrowsers.com/
         *
         * Includes tablets http://detectmobilebrowsers.com/about
         */
        return preg_match(
            '/android|ipad|playbook|silk|(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i',
            $agent
        ) || preg_match(
